        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                <div class="fb_icon">
                    ...
                    <div class="col-sm-3 fb_icon">
                        <?php $facebook_image = esc_attr(get_option('facebook_image')); ?>
                        <?php $facebook_url = esc_attr(get_option('facebook_url')); ?>
                        <?php
                        if (!empty($facebook_image) && !empty($facebook_url)) {

                            echo"<li><a href='{$facebook_url}' target='_blank'><img src='{$facebook_image}' width='70' /></a></li>";
                        }
                        ?>
                    </div>   
                    <div class="col-sm-3 fb_icon">
                        <?php $twietter_image = esc_attr(get_option('twietter_image')); ?>
                        <?php $Twitter_url = esc_attr(get_option('Twitter_url')); ?>
                        <?php
                        if (!empty($twietter_image) && !empty($facebook_url)) {

                            echo"<li><a href='{$Twitter_url}' target='_blank'><img src='{$twietter_image}' width='60' /></a></li>";
                        }
                        ?> 
                    </div>
                    <div class="col-sm-3 fb_icon">
                        <?php $google_image = esc_attr(get_option('google_image')); ?>
                        <?php $google_url = esc_attr(get_option('google_url')); ?>
                        <?php
                        if (!empty($google_image) && !empty($facebook_url)) {

                            echo"<li><a href='{$google_url}' target='_blank'><img src='{$google_image}' width='60' /></a></li>";
                        }
                        ?> 
...
<div class="container">
    <div class="row">
        ...
        <div class="col-sm-3">
            ...
            <h5>  <?php if (is_active_sidebar('sidebar1')) : ?>

    <?php dynamic_sidebar('sidebar1'); ?></h5>
                <h3><?php dynamic_sidebar('idbfooterleft1') ?></h3>
<?php endif; ?>
        </div>
